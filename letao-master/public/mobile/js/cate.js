// 乐淘-分类页面
//分类页面内容: 1.渲染左边列表-请求接口 /category/queryTopCategory得到数据Window.slideData 2.渲染右边内容-根据左边不同id请求右边内容接口'/category/querySecondCategory'
...
//渲染左边列表-请求接口 /category/queryTopCategory得到数据Window.slideData
...
//渲染右边内容-根据左边不同id请求右边内容接口'/category/querySecondCategory'
