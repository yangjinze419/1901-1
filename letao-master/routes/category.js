//分类页面路由信息(包括前台分类,后台分类)-路由拦截前端请求,同时调用后台接口方法Category = require('../models/category.js')里的查询方法queryTopCategory拿到数据
...
//路由拦截前端请求,同时调用后台接口方法Category = require('../models/category.js')里的查询方法queryTopCategory拿到数据
